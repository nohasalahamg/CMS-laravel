...
<html lang="en">
  ...
  <body>
   ...
   <section class="ftco-section ftco-degree-bg">
      <div class="container">
        ...
        asset('/storage/'.$user->getpicture() ) : $user->getavatar() }}" alt="Image placeholder" class="img-fluid mb-4">
              </div>
              <div class="desc">
                <h3>{{ $user->name }}</h3>
                <p>{{ $profile->about }}</p>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Noha Salah <i class="icon-heart color-danger" aria-hidden="true"></i>
