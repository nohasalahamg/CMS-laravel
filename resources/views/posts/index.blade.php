...
<table class="table table-bordered">
  ...
  <span style="color:red" data-toggle="modal" data-target="#delete{{ $pot->id }}"> {{ $pot->trashed() ? 'Delete' : 'trash' }} </span>|
...
@if(! $pot->trashed())
   ...
   @else
   <a href="{{route('trashed.restore',$pot->id )}}"> <span style="color:black"> restore| </span></a> 

   @endif


   <a href="{{route('post.show',$pot->id )}}"> <span style="color:green">view </span></a>
